...
export function EventVideo({ plan, groupId = "A" }: { plan: EventPlan; groupId?: string }) {
  ...
  async function exportWebm() {
    ...
    if (!target || typeof MediaRecorder === "undefined" || !target.captureStream) return;
